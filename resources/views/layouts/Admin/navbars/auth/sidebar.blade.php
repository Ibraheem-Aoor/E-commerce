        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link  {{ Route::currentRouteName() == 'admin.sale.date' ||Route::currentRouteName() == 'admin.coupons.add' ||Route::currentRouteName() == 'admin.coupons'? 'active': '' }}"
                    ...
                    aria-controls="collapseExample5" style="cursor: pointer">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;"
                            class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                    ...
                    <span class="nav-link-text ms-1">Sales Mangaement</span>
                </a>
                <ul class="navbar-nav px-3 collapse" id="collapseExample5">
                    <li class="nav-item">
                        <a href="{{ route('admin.sale.date') }}" class="nav-link">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <span class="nav-link-text ms-1">Sales Date</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.coupons.add') }}" class="nav-link">
                            ...
                            <span class="nav-link-text ms-1">New Coupon</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="navbar-nav px-3 collapse" id="collapseExample">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.home.categories') }}" class="nav-link">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Route::currentRouteName() == 'admin.products' ||Route::currentRouteName() == 'admin.products.add' ||Route::currentRouteName() == 'admin.products.edit' ||Route::currentRouteName() == 'admin.home.categories'? 'active': '' }}"
                    ...
                    aria-controls="collapseExample3" style="cursor: pointer">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <ul class="navbar-nav px-3 collapse" id="collapseExample3">
                    <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ Route::currentRouteName() == 'admin.orders' ||Route::currentRouteName() == 'admin.orders.deatils' ||Route::currentRouteName() == 'admin.transactions'? 'active': '' }}"
                    data-bs-toggle="collapse" data-bs-target="#collapseExample_7" aria-expanded="false"
                    aria-controls="collapseExample_7" style="cursor: pointer">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <ul class="navbar-nav px-3 collapse" id="collapseExample_7">
                    <li class="nav-item">
