                                        ...
                                        @forelse($latestUsers as $user)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <span
                                                        class="text-xs font-weight-bold">{{ $user->created_at->diffForHumans() }}</span>
                                                </td>
...
<script>
    ...
    const myChart = new Chart(ctx, {
        type: 'pie',
        data: {
            labels: ['Users', 'Orders', 'Categories', 'Products'],
            datasets: [{
                label: '# of Votes',
                data: ["{{$numberOfUsers}}", "{{$numberOfOrders}}", "{{$numberOfCategories}}","{{$numberOfProducts}}"],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
