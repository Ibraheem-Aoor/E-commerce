                        ...
                        <div class="wrap-product-detail">
                            ...
                            <div class="detail-info">
                                ...
                                <div class="wrap-butons">
                                    ...
                                    <a href="#" class="btn add-to-cart" wire:click.prevent="storeItem( {{$product->id}} , '{{$product->name}}' , {{$product->sale_price}} )">Add to Cart</a>
                                    <div class="wrap-btn">
                                        ...
                                        <li class="product-item">
                                            <div class="product product-widget-style">
                                                <div class="thumbnnail">
                                                    <a href="details/{{ $p->id }}" title="{{ $p->name }}">
                                                        <figure><img
                                    ...
                                    @forelse($relatedProducts as $r)
                                        <div class="product product-style-2 equal-elem ">
                                            <div class="product-thumnail">
                                                <a href="details/{{ $r->id }}" title="{{ $r->id }}">
                                                    <figure><img
